//
//
// SQL Helper Class by Brendon Dugan
//
// Included to facilitate Database Management.
//
...
public class SQLiteDB
{
    ...
    {
        dbConnection = String.Format("Data Source={0}; Foreign Keys=true; FailIfMissing=True;", inputFile);
    }
    ...
    ///     Use @param1, @param2, etc. in your query to use params. There is no @param0
    /// </summary>
